...
public class FourFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fourlayout, container, false);
	...
	public void getData() {
		...
		Course c1 = new Course("网络自主学习", room, 1, 1, 1,1);
		list1.add(c1);
		list1.add(new Course("网络自主学习", room, 2, 1, 2,1));
		courseData[0] = list1;

		List<Course> list2 = new ArrayList<Course>();
		list2.add(new Course("网络自主学习", room, 1, 1, 1,2));
		list2.add(new Course("网络自主学习", room, 2, 1, 2,2));
		list2.add(new Course("网络自主学习", room, 3, 1, 3,2));
		list2.add(new Course("网络自主学习", room, 4, 1, 4,2));

		courseData[1] = list2;

		List<Course> list6 = new ArrayList<Course>();
		list6.add(new Course("网络自主学习", room, 1, 1, 1,3));
		list6.add(new Course("网络自主学习", room, 2, 1, 2,3));
		courseData[2] = list6;

		List<Course> list3 = new ArrayList<Course>();
		list3.add(new Course("网络自主学习", room, 3, 1, 3,4));
		list3.add(new Course("网络自主学习", room, 4, 1, 4,4));
		courseData[3] = list3;

		List<Course> list4 = new ArrayList<Course>();
		list4.add(new Course("网络自主学习", room, 3, 1, 3,5));
		list4.add(new Course("网络自主学习", room, 4, 1, 4,5));
		list4.add(new Course("网络自主学习", room, 5, 1, 5,5));
		courseData[4] = list4;

		List<Course> list5 = new ArrayList<Course>();
		list5.add(new Course("网络自主学习", room, 3, 1, 3,7));
		list5.add(new Course("网络自主学习", room, 4, 1, 4,7));
		courseData[6] = list5;
